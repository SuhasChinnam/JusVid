...
public class DashboardController {
    ...
    @Value("${jusvid.pageSize}")
    private int defaultPageSize;

//    @Value("${jusvid.contact.successMsg}")
...
//        }
    ...
    private void logMessages() {
        ...
        log.error("defaultPageSize value with Environment is : "+environment.getProperty("jusvid.pageSize"));
        //log.error("successMsg value with Environment is : "+environment.getProperty("jusvid.contact.successMsg"));
